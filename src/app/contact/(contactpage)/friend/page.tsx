...
import { faAngleLeft, faEllipsis, faUserCheck } from '@fortawesome/free-solid-svg-icons';
        ...
        async function searchListuser() {
            ...
            try {
                const response = await fetch(
                    `${process.env.NEXT_PUBLIC_API_ENDPOINT}/api/searchfriends/${currentUserId}/${debounce}`,
                    {
                        headers: {
                            'Content-Type': 'application/json',
                        },
    ...
    return (
        <div className="flex relative">
            ...
            <div className="w-full h-screen flex md:relative">
                <ContactSibar activePage="friend" />
                        ...
                        <div className="px-5  border-b">
                            <div className="flex h-16 leading-[64px] ">
                                ...
                                <div className="ml-3 h-full ">
                                    <h3 className="font-medium text-base leading-[64px] ">Danh sách bạn bè</h3>
                                </div>
                            </div>
                        </div>
                        <div className="bg-text5 p-5 font-medium text-sm flex-1 overflow-y-auto ">
                            <p className="pb-5 ">Bạn bè</p>
                                        ...
                                        >
                                            <div className="px-2">
                                                <Avatar className="w-12 h-12 my-[11px] md:w-10 md:h-10 md:my-[15px]">
                                                    ...
                                                    <AvatarFallback>{listFriend.userInfo?.username}</AvatarFallback>
                                                </Avatar>
                                            </div>
