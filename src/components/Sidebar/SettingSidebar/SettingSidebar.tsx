...
function SettingSidebar() {
    ...
    return (
        <div className="w-[70px] flex flex-col justify-between overflow-y-auto bg-sky-500">
            <div className="flex flex-col ">
                <Link
                    className={`text-2xl text-white p-5 hover:cursor-pointer  ${
                        isHomePage ? 'bg-sky-600' : 'hover:bg-sky-600'
                    }`}
                    href={'/'}
                >
                ...
                <Link
                    className={`text-2xl text-white p-5 hover:cursor-pointer  ${
                        isContactPage ? 'bg-sky-600' : 'hover:bg-sky-600'
                    }`}
                    href={'/contact/friend'}
                >
            ...
            <div className="flex flex-col">
                <Dialog>
                    <DialogTrigger
                        className="justify-start text-2xl text-white p-5 hover:cursor-pointer hover:bg-sky-600"
                        asChild
                    >
                ...
                <DropdownMenu>
                    <DropdownMenuTrigger className="justify-start text-2xl text-white p-5 hover:cursor-pointer hover:bg-sky-600">
                        <FontAwesomeIcon icon={faGear} />
                    </DropdownMenuTrigger>
                    <DropdownMenuContent className="ml-[65px] mb-[-20px] w-[250px]">
                        <DropdownMenuLabel className="h-9 text-base">Cài đặt</DropdownMenuLabel>
                        <DropdownMenuSeparator />
                            ...
                            <Dialog>
                                <DialogTrigger className="justify-start" asChild>
                                    <Button
                                        ...
                                        variant="ghost"
                                    >
                                        <FontAwesomeIcon className="text-text3 mr-2 w-[14px]" icon={faUser} /> Thông tin
                                        tài khoản
                                    </Button>
                                </DialogTrigger>
                                <DialogContent className="sm:max-w-[425px] bg-white overflow-hidden">
                                    ...
                                    <div className="flex h-16 leading-[64px]">
                                        ...
                                        <div className="flex ml-4">
                                            <h3 className="text-lg font-medium leading-[64px]">{infoUser?.username}</h3>
                                            <div
                                                className="hover:cursor-pointer"
                                                onClick={() => setIsOpenProfile(true)}
                                            >
                                                <FontAwesomeIcon
                                                    className="text-sm ml-2 te w-[14px]xt-text2"
                                                    icon={faPen}
                                                />
                                            </div>
                                        </div>
                                    ...
                                    <div className="w-full my-[-10px]">
                                        ...
                                        >
                                            <div className="flex">
                                                <div>
                                                    <FontAwesomeIcon
                                                        className="text-sm text-te w-[14px]xt2"
                                                        icon={faPen}
                                                    />
                                                </div>
                                                <h4 className="text-base font-medium ml-2 leading-[40px]">Cập nhật</h4>
                                            </div>
                                        </Button>
                                    </div>
                            ...
                            <Dialog>
                                <DialogTrigger className="justify-start" asChild>
                                    <Button className="w-full font-normal px-2" variant="ghost">
                                        <FontAwesomeIcon className="text-text3 mr-2 w-[14px]" icon={faGear} /> Cài đặt
                                    </Button>
                                </DialogTrigger>
                                <DialogContent className="sm:max-w-[425px] bg-white overflow-hidden">
                                    <DialogHeader>
                        ...
                        <div className="w-full cursor-pointer h-9 text-sm">
                            <Dialog>
                                <DialogTrigger className="justify-start" asChild>
                                    <Button className="w-full font-normal px-2" variant="ghost">
                                        <FontAwesomeIcon className="text-text3 mr-2 w-[14px]" icon={faDatabase} /> Dữ
                                        liệu
                                    </Button>
                                </DialogTrigger>
                                <DialogContent className="sm:max-w-[425px] bg-white overflow-hidden">
                        ...
                        <div className="w-full cursor-pointer h-9 text-sm">
                            <Dialog>
                                <DialogTrigger className="justify-start" asChild>
                                    <Button className="w-full font-normal px-2" variant="ghost">
                                        <FontAwesomeIcon className="text-text3 mr-2 w-[14px]" icon={faWrench} /> Công cụ
                                    </Button>
                                </DialogTrigger>
                                <DialogContent className="sm:max-w-[425px] bg-white overflow-hidden">
                                    <DialogHeader>
                        ...
                        <div className="w-full cursor-pointer h-9 text-sm">
                            <Dialog>
                                <DialogTrigger className="justify-start" asChild>
                                    <Button className="w-full font-normal px-2" variant="ghost">
                                        <FontAwesomeIcon className="text-text3 mr-2" icon={faGlobe} /> Ngôn ngữ
                                    </Button>
                                </DialogTrigger>
                                <DialogContent className="sm:max-w-[425px] bg-white overflow-hidden">
                                    <DialogHeader>
                        ...
                        <div className="w-full cursor-pointer h-9 text-sm">
                            <Dialog>
                                <DialogTrigger className="justify-start" asChild>
                                    <Button className="w-full font-normal px-2" variant="ghost">
                                        <FontAwesomeIcon className="text-text3 mr-2" icon={faExclamationCircle} /> Giới
                                        thiệu
                                    </Button>
                                </DialogTrigger>
                                <DialogContent className="sm:max-w-[425px] bg-white overflow-hidden">
                        ...
                        <DropdownMenuSeparator />
                        <DropdownMenuItem onClick={handleLogout} className="cursor-pointer h-9">
                            <p className="text-sm text-red-700 ml-[22px]">Đăng xuất</p>
                        </DropdownMenuItem>
                    </DropdownMenuContent>
                </DropdownMenu>
            </div>
